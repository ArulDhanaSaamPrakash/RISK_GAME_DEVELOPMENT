    ...
    <div class="container">
        ...
        <header>
            ...
            <h1>RISK GAME - <span style="color:red;">Carnegie Mellon University</span></h1>
                ...
                <br>
                Code Build Date: 11/21/2017 <!-- This is the place to UPDATE THE CODE BUILD TIME -->
                </div>
                <br>
            ...
            <div id="container_demo" >
                ...
                <div id="wrapper">
                    <div id="login" class="animate form">
                        <form  id="loginform" method ="POST"  action=""""),_display_(/*258.72*/routes/*258.78*/.LoginController.login()),format.raw/*258.102*/("""">
                            <h1>Log in</h1>
                            <p>
