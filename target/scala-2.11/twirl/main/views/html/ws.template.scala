...
"""),format.raw/*92.1*/("""}"""),format.raw/*92.2*/("""
    ...
    $('#btnLeave').click(function (e) """),format.raw/*126.39*/("""{"""),format.raw/*126.40*/("""

        """),format.raw/*128.9*/("""var data = JSON.stringify("""),format.raw/*128.35*/("""{"""),format.raw/*128.36*/(""""type": "leaving", "player": """),format.raw/*128.65*/("""{"""),format.raw/*128.66*/(""""username": username"""),format.raw/*128.86*/("""}"""),format.raw/*128.87*/("""}"""),format.raw/*128.88*/(""");
        socket.send(data);
