...
console.log(obj);
  ...
  <body>
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li> <a href="javascript:special()" >Logout</a></li>
      <li>&nbsp;&nbsp;&nbsp;</li>
      </ul>
    <br>
    </header>
