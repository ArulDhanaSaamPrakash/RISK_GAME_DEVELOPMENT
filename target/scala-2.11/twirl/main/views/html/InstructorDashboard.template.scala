...
<html>
  ...
  """),format.raw/*219.3*/("""</script>

  </head>
  <body>
    """),_display_(/*223.6*/header()),format.raw/*223.14*/("""<br>
  <div class="row">
    <div class="col-md-12">
      <h3>
               Welcome """),_display_(/*227.25*/Http/*227.29*/.Context.current().args.get("firstname").asInstanceOf[String]),format.raw/*227.90*/("""
              """),format.raw/*228.15*/("""</h3>
    <form method="GET" action="/exportReports">
  ...
  <form method="GET" action="/exportRiskProblemReport">
      <label>Risk vs Problem Report </label> <br>
      <input type="text" id="exportRiskProblemReport" name="exportRiskProblemReport" placeholder="Enter gameID">
      <input type="submit" name="Export" value="Export" style="height: 30px; width: 100px;">
  </form>
  ...
  """),format.raw/*256.16*/("""
      ...
      """),format.raw/*261.20*/("""
        ...
        """),format.raw/*263.9*/("""<!-- Host Game Modal -->
              ...
              <form class="form-horizontal">
                <fieldset>
                  ...
                  <legend>Game Settings</legend>
                    ...
                    """),format.raw/*298.21*/("""<!-- Select Basic -->
  ...
  <div class="row">
    ...
    """),_display_(/*401.6*/footer()),format.raw/*401.14*/("""
  """),format.raw/*402.3*/("""</body>
</html>"""))
      }
    }
  }
