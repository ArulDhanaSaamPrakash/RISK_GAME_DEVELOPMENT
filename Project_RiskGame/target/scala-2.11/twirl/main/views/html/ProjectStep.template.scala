                ...
                <div class="col-md-8 card" style="border: 1px solid transparent">
                                          ...
                                          <div style="text-align:center;">
                                              ...
                                              <div style="border:1px solid #000; display:inline-block;position:absolute;top:0;left:0;">
                                                  Budget:<div style=" display: inline; float: right " id="budgetremaining"> """),_display_(/*1045.126*/model/*1045.131*/.getBudget()),format.raw/*1045.143*/("""</div>
                                                    <br>
                                                      Capability Points:<div style=" display: inline; float: right" id="capabilitypoints"> """),_display_(/*1047.141*/model/*1047.146*/.getCapabilityPoints()),format.raw/*1047.168*/("""</div>
                                                    <br>
                                                      Capability Bonus:<div style=" display: inline; float: right" id="capabilitybonus"> """),_display_(/*1049.139*/model/*1049.144*/.getCapabilityBonus()),format.raw/*1049.165*/("""</div>
                                                    <br>
                                                </div>

                                                <div style="border:1px solid #000; display:inline-block;">
                                                  <div style=" display: inline-block;">Personnel:</div><div style=" display: inline-block; float: right" id="personnelremaining"> """),_display_(/*1054.180*/model/*1054.185*/.getResources),format.raw/*1054.198*/("""</div>
...
<div></div>
                                          ...
                                          """),format.raw/*1080.43*/("""<div class="modal fade" id="myAssetModal" role="dialog">
                                              <div class="modal-dialog">
                                                  ...
                                                  <div class="modal-content">
                                                      ...
                                                      <div class="modal-body" style="text-align: left">
                                                          <div>Budget Remaining: """),_display_(/*1090.83*/model/*1090.88*/.getBudget()),format.raw/*1090.100*/("""</div>
                                                          <div>Capability Points: """),_display_(/*1091.84*/model/*1091.89*/.getCapabilityPoints()),format.raw/*1091.111*/("""</div>
                                                          <div>Capability Bonus: """),_display_(/*1092.83*/model/*1092.88*/.getCapabilityBonus()),format.raw/*1092.109*/("""</div>
                        ...
                        <div id="projectSteps" class="tab-pane fade in active">
                            <div class="col-md-12" style="border: 1px solid transparent">
                                ...
                                <div id="listOfProjectSteps">
                                    ...
                                    """),_display_(/*1130.38*/for(phase <- model.getPhases()) yield /*1130.69*/ {_display_(Seq[Any](format.raw/*1130.71*/("""
                                        """),_display_(/*1131.42*/if(phase.getPhaseName().equalsIgnoreCase("PLANNING"))/*1131.95*/{_display_(Seq[Any](format.raw/*1131.96*/("""

                                            """),format.raw/*1133.45*/("""<button  class="col-md-3 btn btn-warning"
                                            style="background-color: #DB8B00 !important;"
                                            onclick="onPhaseClick(id)"
                                        ...
                                        """)))}/*1138.42*/else/*1138.46*/{_display_(Seq[Any](format.raw/*1138.47*/("""
                                            """),format.raw/*1139.45*/("""<button disabled="true" class="col-md-3 btn btn-warning"
                                            style="background-color: #DB8B00 !important;"
                                            onclick="onPhaseClick(id)"
                                            id="""),_display_(/*1142.49*/phase/*1142.54*/.getPhaseId),format.raw/*1142.65*/(""">"""),_display_(/*1142.67*/phase/*1142.72*/.getPhaseName()),format.raw/*1142.87*/("""</button>
                                            <div class="col-md-1" style="height: 40px;"> </div>
                                        """)))}),format.raw/*1144.42*/("""
                ...
                <div class="col-md-2" style="border-left: 1px Dashed #969C9E;
                    ...
                    """),format.raw/*1228.21*/("""<div class="panel panel-default" >
                        <div class="panel-heading" style="background-color: #A8A2A3">
