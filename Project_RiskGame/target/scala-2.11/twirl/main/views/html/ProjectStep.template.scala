                ...
                <div class="col-md-8 card" style="border: 1px solid transparent">
                                          ...
                                          <div style="text-align:center;">
                                              ...
                                              <div style="border:1px solid #000; display:inline-block;position:absolute;top:0;left:0;">
                                                  Budget:<div style=" display: inline; float: right " id="budgetremaining"> """),_display_(/*1038.126*/model/*1038.131*/.getBudget()),format.raw/*1038.143*/("""</div>
                                                    <br>
                                                      Capability Points:<div style=" display: inline; float: right" id="capabilitypoints"> """),_display_(/*1040.141*/model/*1040.146*/.getCapabilityPoints()),format.raw/*1040.168*/("""</div>
                                                    <br>
                                                      Capability Bonus:<div style=" display: inline; float: right" id="capabilitybonus"> """),_display_(/*1042.139*/model/*1042.144*/.getCapabilityBonus()),format.raw/*1042.165*/("""</div>
                                                    <br>
                                                </div>

                                                <div style="border:1px solid #000; display:inline-block;">
                                                  <div style=" display: inline-block;">Personnel:</div><div style=" display: inline-block; float: right" id="personnelremaining"> """),_display_(/*1047.180*/model/*1047.185*/.getResources),format.raw/*1047.198*/("""</div>
...
<div></div>
                                          ...
                                          """),format.raw/*1073.43*/("""<div class="modal fade" id="myAssetModal" role="dialog">
                                              <div class="modal-dialog">
                                                  ...
                                                  <div class="modal-content">
                                                      ...
                                                      <div class="modal-body" style="text-align: left">
                                                          <div>Budget Remaining: """),_display_(/*1083.83*/model/*1083.88*/.getBudget()),format.raw/*1083.100*/("""</div>
                                                          <div>Capability Points: """),_display_(/*1084.84*/model/*1084.89*/.getCapabilityPoints()),format.raw/*1084.111*/("""</div>
                                                          <div>Capability Bonus: """),_display_(/*1085.83*/model/*1085.88*/.getCapabilityBonus()),format.raw/*1085.109*/("""</div>
                        ...
                        <div id="projectSteps" class="tab-pane fade in active">
                            <div class="col-md-12" style="border: 1px solid transparent">
                                ...
                                <div id="listOfProjectSteps">
                                    ...
                                    """),_display_(/*1123.38*/for(phase <- model.getPhases()) yield /*1123.69*/ {_display_(Seq[Any](format.raw/*1123.71*/("""
                                        """),_display_(/*1124.42*/if(phase.getPhaseName().equalsIgnoreCase("PLANNING"))/*1124.95*/{_display_(Seq[Any](format.raw/*1124.96*/("""

                                            """),format.raw/*1126.45*/("""<button  class="col-md-3 btn btn-warning"
                                            style="background-color: #DB8B00 !important;"
                                            onclick="onPhaseClick(id)"
                                            id="""),_display_(/*1129.49*/phase/*1129.54*/.getPhaseId),format.raw/*1129.65*/(""">"""),_display_(/*1129.67*/phase/*1129.72*/.getPhaseName()),format.raw/*1129.87*/("""</button>
                                            <div class="col-md-1" style="height: 40px;"> </div>
                                        """)))}/*1131.42*/else/*1131.46*/{_display_(Seq[Any](format.raw/*1131.47*/("""
                                            """),format.raw/*1132.45*/("""<button disabled="true" class="col-md-3 btn btn-warning"
                                            style="background-color: #DB8B00 !important;"
                                            onclick="onPhaseClick(id)"
                ...
                <div class="col-md-2" style="border-left: 1px Dashed #969C9E;
                    ...
                    """),format.raw/*1221.21*/("""<div class="panel panel-default" >
                        <div class="panel-heading" style="background-color: #A8A2A3">
